...
/*
 ...
 Please read the instructions here: https://github.com/billerickson/Georgia-Sex-Offense-Law/wiki
*/
...
require get_template_directory() . '/inc/print-and-pdf.php';
require get_template_directory() . '/inc/after-post-page-entry.php';
require get_template_directory() . '/inc/disable-editor.php';

/**
 * Enqueue scripts and styles. : =enqueue
 */
function ea_scripts() {
    ...
    // Fonts
    wp_enqueue_style( 'ea-fonts', 'https://fonts.googleapis.com/css?family=Montserrat:700|Unna:400,700' );
